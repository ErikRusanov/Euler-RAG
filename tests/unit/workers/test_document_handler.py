...
def mock_mathpix_client():
    """Create mock MathpixClient."""
    client = AsyncMock(spec=MathpixClient)
    # Mock successful line extraction
    client.extract_lines = AsyncMock(
        return_value={
            "pages": [
                {
                    "page": 1,
...
def document_handler(
    mock_session_factory, mock_s3, mock_progress_tracker, mock_mathpix_client
):
    ...
    return DocumentHandler(
        ...
        mathpix_client=mock_mathpix_client,
    )
